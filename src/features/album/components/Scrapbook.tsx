...
type Props = { state: BookState; page: ScrapbookPage | null; nextPage?: ScrapbookPage | null; onAdvance: () => void; direction: 'next' | 'previous' }

export function Scrapbook({ state, page, nextPage, onAdvance, direction }: Props) {
