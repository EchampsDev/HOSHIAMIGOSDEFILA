...
export function Scrapbook({ state, page, onAdvance, direction }: Props) {
  if (state === 'CLOSED') return <button type="button" className="scrapbook-cover front-cover" onClick={onAdvance} aria-label="Abrir la libreta"><SpiralBinding cover /><span>BRATTYPOLITAN</span><strong>ARCHIVO<br />COLECTIVO</strong><small>clic para abrir</small></button>
