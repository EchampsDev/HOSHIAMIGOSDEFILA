...
type Props = { page: ScrapbookPage; bookmarkPage?: number; selectedId?: string | null; editable?: boolean; canEditAll?: boolean; viewerId?: string | null; revealAll?: boolean; canInspectAll?: boolean; reactionsByElement?: Record<string, string[]>; showBinding?: boolean; onSelect?: (id: string) => void; onLike?: (element: AlbumElement) => void; onElementPointerDown?: (event: React.PointerEvent<HTMLDivElement>, element: AlbumElement, mode: GestureMode) => void; onBackgroundPointerDown?: () => void }
