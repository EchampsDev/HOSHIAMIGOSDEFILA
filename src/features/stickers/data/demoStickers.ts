...
export const demoStickers: CommunitySticker[] = [
  { id: 'demo-four-point-star', title: 'Estrella roja', description: 'La estrella de cuatro puntas que acompaña la experiencia.', authorName: 'HOSHIAMIGOS DE FILA', assetUrl: '/images/stickers/demo-four-point-star.png', mimeType: 'image/png', fileSize: 298698, originalWidth: 1254, originalHeight: 1254, safeFileName: 'estrella-roja-hoshiamigos.png', status: 'APPROVED', visibility: 'PUBLIC', createdAt, updatedAt: createdAt },
