...
async function makePreview(tracks: SetlistTrack[], authorName: string, page: number, title: string) {
  ...
  context.fillText('BRATTYPOLITAN EXPERIENCE', 70, 80)
