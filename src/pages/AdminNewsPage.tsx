...
export function AdminNewsPage() {
  ...
  const uploadImages = async (event: ChangeEvent<HTMLInputElement>) => {
    ...
    setBusy(true)
    try {
      const uploaded = await newsImageRepository.upload(editing.id, files, session.user ? await session.user.getIdToken() : undefined)
